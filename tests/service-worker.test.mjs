...
test("service worker v6 serves static cache hits without an eager network request", async () => {
...
test("service worker v6 stores an eligible cache miss before resolving the response", async () => {
...
test("service worker keeps offline navigation fallback and lifecycle work attached to events", async () => {
  ...
  await activateWork;
  assert.deepEqual(harness.deleted, ["marketo-static-v5"]);
