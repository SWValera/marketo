...
export const passengerVehicleModels = [
  ...dependentOptions({
    ...
    toyota: [
      "2000GT", "4Runner", "Allex", "Allion", "Alphard", "Altezza", "Aristo", "Aurion",
      "Auris", "Avalon", "Avensis", "Avensis Verso", "Aygo", "bB", "Bandeirante",
      "Belta", "Blade", "Blizzard", "Brevis", "bZ4X", "C-HR", "Caldina", "Cami",
      "Camry", "Camry Solara", "Carib", "Carina", "Carina E", "Carina ED", "Cavalier",
      "Celica", "Celsior", "Century", "Chaser", "Comfort", "Corolla", "Corolla Ceres",
      "Corolla Cross", "Corolla FX", "Corolla Fielder", "Corolla Levin", "Corolla Rumion",
      "Corolla RunX", "Corolla Spacio", "Corolla Verso", "Corona", "Corsa", "Cressida",
      "Cresta", "Crown", "Crown Estate", "Crown Majesta", "Crown Wagon", "Curren",
      "Cygnus", "Cynos", "Duet", "Echo", "Estima", "FJ Cruiser", "Fortuner", "Funcargo",
      "GR86", "GT86", "Gaia", "Gracia", "Grand Hiace", "Granvia", "Harrier", "Hiace",
      "Highlander", "Hilux", "Hilux Surf", "Innova", "Ipsum", "Isis", "Ist", "Kluger",
      ...
      "Land Cruiser Prado 150", "Lite Ace", "MR2", "MR-S", "Mark II", "Mark X",
      "MasterAce", "Matrix", "Mega Cruiser", "Nadia", "Noah", "Opa", "Origin", "Paseo",
      "Passo", "Picnic", "Platz", "Porte", "Premio", "Previa", "Prius", "Probox",
      "Progres", "Pronard", "Publica", "RAV4", "Ractis", "Raize", "Raum", "Regius",
      "Regius Ace", "Rush", "Sai", "Scepter", "Sequoia", "Sera", "Sienna", "Sienta",
      "Soarer", "Solara", "Soluna", "Sparky", "Sprinter", "Starlet", "Succeed", "Supra",
      "Tacoma", "Tercel", "Touring Hiace", "Town Ace", "Tundra", "Urban Cruiser",
      "Vanguard", "Vellfire", "Venza", "Verossa", "Verso", "Vios", "Vista", "Vitz",
      "Voltz", "Voxy", "WiLL", "Windom", "Wish", "Yaris", "Yaris Cross", "Yaris Verso", "iQ",
    ],
  ...
  ...dependentOptions({
    alpina: ["B3", "B4", "B5", "B7", "XD3", "XD4"],
    aito: ["M5", "M7", "M9"],
    arcfox: ["Alpha S", "Alpha S5", "Alpha T", "Alpha T5", "Kaola"],
    "aston-martin": ["DB7", "DB9", "DB11", "DB12", "DBS", "DBX", "Rapide", "Vanquish", "Vantage"],
    aurus: ["Arsenal", "Komendant", "Senat"],
    brilliance: ["BS4", "BS6", "H230", "H320", "H330", "H530", "V3", "V5", "V6", "V7"],
    bugatti: ["Chiron", "Mistral", "Veyron"],
    buick: ["Enclave", "Encore", "Envision", "GL8", "LaCrosse", "Regal", "Verano"],
    changhe: ["A6", "Freedom M50", "Q25", "Q35", "Q7"],
    cupra: ["Ateca", "Born", "Formentor", "Leon", "Tavascan", "Terramar"],
    dacia: ["Dokker", "Duster", "Jogger", "Lodgy", "Logan", "Sandero", "Spring"],
    datsun: ["240Z", "280Z", "280ZX", "Cross", "GO", "GO+", "mi-DO", "on-DO"],
    deepal: ["G318", "L07", "S05", "S07", "SL03"],
    denza: ["D9", "N7", "N8", "Z9", "Z9 GT"],
    ds: ["DS 3", "DS 4", "DS 5", "DS 7", "DS 9"],
    ferrari: ["296 GTB", "488", "812 Superfast", "California", "F8 Tributo", "Portofino", "Purosangue", "Roma"],
    fisker: ["Karma", "Ocean"],
    foton: ["Gratour", "Sauvana", "Tunland", "Tunland G7", "Tunland G9", "View"],
    gmc: ["Acadia", "Canyon", "Savana", "Sierra", "Terrain", "Yukon"],
    haima: ["3", "7", "8S", "M3", "M5", "S5", "S7"],
    hummer: ["H1", "H2", "H3", "Hummer EV"],
    ineos: ["Grenadier", "Quartermaster"],
    "iran-khodro": ["Dena", "Runna", "Samand", "Soren", "Tara"],
    iveco: ["Daily", "Massif"],
    jetta: ["VA3", "VS5", "VS7"],
    kaiyi: ["E5", "E5 EV", "X3", "X3 Pro", "X7 Kunlun"],
    kgm: ["Actyon", "Korando", "Musso", "Rexton", "Tivoli", "Torres", "Torres EVX"],
    lamborghini: ["Aventador", "Gallardo", "Huracan", "Murcielago", "Revuelto", "Temerario", "Urus"],
    lancia: ["Delta", "Thema", "Thesis", "Voyager", "Ypsilon"],
    leapmotor: ["B10", "C01", "C10", "C11", "C16", "T03"],
    lifan: ["Breez", "Cebrium", "Myway", "Smily", "Solano", "X50", "X60", "X70", "X80"],
    lincoln: ["Aviator", "Continental", "Corsair", "MKC", "MKT", "MKZ", "Nautilus", "Navigator", "Town Car"],
    lotus: ["Elise", "Eletre", "Emeya", "Emira", "Evora", "Exige"],
    lucid: ["Air", "Gravity"],
    luxeed: ["R7", "S7"],
    "lynk-co": ["01", "03", "05", "06", "08", "09", "Z10", "Z20"],
    maserati: ["Ghibli", "GranCabrio", "GranTurismo", "Grecale", "Levante", "MC20", "Quattroporte"],
    maxus: ["D60", "D90", "G10", "G20", "G50", "MIFA 9", "T60", "T90"],
    maybach: ["57", "57 S", "62", "62 S"],
    mclaren: ["570S", "600LT", "650S", "720S", "750S", "Artura", "GT", "P1"],
    mercury: ["Cougar", "Grand Marquis", "Mariner", "Milan", "Montego", "Mountaineer", "Sable"],
    mg: ["3", "4 EV", "5", "6", "Cyberster", "HS", "RX5", "ZS"],
    mini: ["Aceman", "Clubman", "Countryman", "Coupe", "Hatch", "Paceman", "Roadster"],
    moskvich: ["3", "3e", "6", "8", "2140", "2141", "Святогор"],
    neta: ["Aya", "GT", "L", "S", "U", "V", "X"],
    nio: ["EC6", "EC7", "ES6", "ES7", "ES8", "ET5", "ET5 Touring", "ET7", "ET9"],
    oldsmobile: ["Alero", "Aurora", "Bravada", "Cutlass", "Intrigue", "Silhouette"],
    ora: ["07", "Ballet Cat", "Good Cat", "Lightning Cat"],
    pagani: ["Huayra", "Utopia", "Zonda"],
    plymouth: ["Barracuda", "Breeze", "Neon", "Prowler", "Voyager"],
    polestar: ["1", "2", "3", "4"],
    pontiac: ["Bonneville", "Firebird", "G6", "Grand Prix", "GTO", "Solstice", "Torrent", "Vibe"],
    proton: ["Exora", "Iriz", "Persona", "S70", "Saga", "X50", "X70", "X90"],
    ram: ["1500", "2500", "3500", "Dakota", "Rampage"],
    ...
    seres: ["Seres 3", "Seres 5", "Seres 7", "SF5"],
    skywell: ["BE11", "ET5", "HT-i"],
    smart: ["#1", "#3", "#5", "Forfour", "Fortwo"],
    soueast: ["A5", "DX3", "DX5", "DX7", "DX8"],
    ssangyong: ["Actyon", "Actyon Sports", "Korando", "Korando Sports", "Kyron", "Musso", "Rexton", "Rodius", "Tivoli"],
    tank: ["300", "400", "500", "700"],
    tata: ["Harrier", "Hexa", "Indica", "Indigo", "Nano", "Nexon", "Punch", "Safari", "Tiago", "Tigor"],
    vauxhall: ["Astra", "Corsa", "Crossland", "Grandland", "Insignia", "Mokka", "Vectra", "Zafira"],
    voyah: ["Courage", "Dream", "Free", "Passion"],
    wey: ["Coffee 01", "Coffee 02", "Latte", "Macchiato", "Mocha", "VV5", "VV6", "VV7"],
    wuling: ["Air EV", "Almaz", "Bingo", "Confero", "Cortez", "Hongguang Mini EV", "Victory"],
    xiaomi: ["SU7", "YU7"],
    xpeng: ["G3", "G6", "G9", "Mona M03", "P5", "P7", "X9"],
    zaz: ["965", "966", "968", "Chance", "Forza", "Lanos", "Sens", "Slavuta", "Tavria", "Vida"],
    zotye: ["Coupa", "Damai X5", "Damai X7", "T300", "T500", "T600", "T700", "Z100", "Z300"],
  }),
